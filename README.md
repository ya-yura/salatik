...
## 1. Сервисы и страницы части заказчика
...
### 2.4 Функциональность для разных ролей
...
#### 2.4.2. Роль «Аутентифицированный пользователь (заказчик)»:
